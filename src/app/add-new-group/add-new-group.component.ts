...
export class AddNewGroupComponent implements OnInit {
  ...
  private submitList() {
    if(this.userlistform.invalid){
      ...
      //const API_URL="http://caivaportalpluswebservices.azurewebsites.net/api/User/CreateNewGroup";
      //const API_URL=this.apiService.API_URL+this.apiService.CreateNewGroup;
      // const headers = {
      //   headers:new HttpHeaders({
      //     'Authorization':'Bearer '+window.localStorage.getItem('TokenInLocal'),
      //   })

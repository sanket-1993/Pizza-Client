...
export class UpdateGroupComponent implements OnInit {
  ...
  getSpecificGroup(){
   ...
   submitList() {
      ...
      //const API_URL="http://caivaportalpluswebservices.azurewebsites.net/api/User/UpdateGroupInformation";
     // this.http.post(API_URL,GroupDetailsModel,headers).subscribe((response:any) => {
